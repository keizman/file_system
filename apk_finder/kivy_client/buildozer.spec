...
# (str) Package name
package.name = apkfinder

# (str) Package domain (needed for android/ios packaging)
package.domain = com.apkfinder
...
source.exclude_dirs = tests, bin, venv, __pycache__, .git, .github, .vscode, client, server

# (list) List of exclusions using pattern matching
source.exclude_patterns = license,images/*,*.pyc,*~,*.bak,*.swp
...
requirements = python3,kivy==2.1.0,kivymd==1.1.1,httpx==0.24.0,pydantic==2.0.0,python-dotenv==1.0.0,loguru==0.7.0,python-dateutil==2.8.0,certifi
...
# Get a list of available identities: Xcode -> Window -> Devices and Simulators -> [select device] -> [select "Installed Apps" tab] -> [select app] -> [gear icon] -> "Download Container"
